...
const RulebookGuideBeginner: NextPage = () => {
  return (
    <DefaultPage>
      <PageData title="交流のマナー" />
      <SubHeading>交流のマナー</SubHeading>
      <SectionWrapper>
        <p>
          相手の行動や心情を勝手に描写することは確定ロールと呼ばれ、多くの場合マナー違反として扱われます。以下はその例です。
        </p>
        <div>
          「○○って昔けっこうワルだったよな」
          相手の過去を勝手に決めてしまっています。
      ...
      <SubHeading>他キャラクターの設定を侵食しうる設定</SubHeading>
      <SectionWrapper>
        <p>
          このゲームでは多数のキャラクターが同じ世界を共有します。他のキャラクターの設定を侵食しかねない設定を持ったキャラクターを出すべきではありません。
        </p>
        <p>
          例えばこの世界の創造主という設定を持ったキャラクターAがいると、その他のキャラクターにはAによる被造物という設定がついてしまうことになります。一種の確定ロールに当たりますので、このような設定はしないようにしましょう。
        </p>
      </SectionWrapper>
      <SubHeading>他キャラクターのストーリーの破壊行為</SubHeading>
      <SectionWrapper>
        <p>
          キャラクターはそれぞれの背景を持っており、多くはどのようにストーリーを展開するかを考えながらRPされています。そのため、他キャラクターのストーリーを破壊する行為は嫌われます。
        </p>
        <div>
        ...
        <p>
          なお、ストーリーの押し付けに対しては下記のように確定ロールを用いて対抗されることがあります。
        </p>
        <div>
      ...
      <SubHeading>ロールプレイの流れの破壊行為</SubHeading>
      <SectionWrapper>
        <p>
        ...
        <p>
          現実であれば助かる場面かもしれませんが、本人たちは苦手なものを自分たちで頑張って成し遂げる展開そのものを楽しんでいるのかもしれません。現実で喜ばれることが必ずしもRP上で喜ばれることとイコールではないことに注意しましょう。
        </p>
        <p>
      ...
      <SubHeading>プレイヤー自身の属性による言い訳</SubHeading>
      <SectionWrapper>
        <p>
