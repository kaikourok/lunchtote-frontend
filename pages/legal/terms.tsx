          ...
          <ol className={styles['terms-list']}>
            ...
            <li>
              ...
              <ol className={styles['terms-list']}>
                ...
                <li>その他、当サークルが利用登録を相当でないと判断した場合</li>
              </ol>
            </li>
          </ol>
        </div>
      ...
      <section>
        ...
        <div className={styles['terms-wrapper']}>
          <ol className={styles['terms-list']}>
            ...
            <li>
              ユーザーは、いかなる場合にも、パスワードを第三者に譲渡または貸与し、もしくは第三者と共用することはできません。当サークルは、登録番号もしくはメールアドレスとパスワードの組み合わせが登録情報と一致してログインされた場合には、該当のユーザーの登録を行った本人による利用とみなします。
            </li>
            <li>
              パスワードが第三者によって使用されたことによって生じた損害は、当サークルは一切の責任を負わないものとします。
            </li>
          </ol>
        </div>
      </section>
      <section>
        ...
        <div className={styles['terms-wrapper']}>
          ...
          <ol className={styles['terms-list']}>
            ...
            <li>犯罪行為に関連する行為</li>
            <li>
              当サークル、本サービスの他のユーザー、または第三者のサーバーまたはネットワークの機能を破壊したり、妨害したりする行為
            </li>
            ...
            <li>
              当サークル、本サービスの他のユーザーまたは第三者の知的財産権、肖像権、プライバシー、名誉その他の権利または利益を侵害する行為
            </li>
            <li>
              以下の表現を含み、または含むと当サークルが判断する内容を本サービス上に投稿し、または送信する行為
              <ol className={styles['terms-list']}>
                <li>過度に暴力的な表現</li>
                <li>露骨な性的表現</li>
                <li>
            ...
            <li>
              以下を目的とし、または目的とすると当サークルが判断する行為
              <ol className={styles['terms-list']}>
                <li>
                  営業、宣伝、広告、勧誘、その他営利を目的とする行為（当サークルの認めたものを除きます。）
                </li>
                <li>性行為やわいせつな行為を目的とする行為</li>
                <li>面識のない異性との出会いや交際を目的とする行為</li>
                <li>他のユーザーに対する嫌がらせや誹謗中傷を目的とする行為</li>
                <li>
                  当サークル、本サービスの他のユーザー、または第三者に不利益、損害または不快感を与えることを目的とする行為
                </li>
                <li>
      ...
      <section>
        ...
        <div className={styles['terms-wrapper']}>
          <ol className={styles['terms-list']}>
            ...
            <li>
              ユーザーが本サービスを利用して投稿ないしアップロードした文章、画像、映像等の著作権については、当該ユーザーその他既存の権利者に留保されるものとします。ただし、当サークルは、本サービスを利用して投稿ないしアップロードされた文章、画像、映像等について、本サービスの改良、品質の向上、または不備の是正等ならびに本サービスの周知宣伝等に必要な範囲で利用できるものとし、ユーザーは、この利用に関して、著作者人格権を行使しないものとします。
            </li>
            <li>
              前項本文の定めるものを除き、本サービスおよび本サービスに関連する一切の情報についての著作権およびその他の知的財産権はすべて当サークルまたは当サークルにその利用を許諾した権利者に帰属し、ユーザーは無断で複製、譲渡、貸与、翻訳、改変、転載、公衆送信（送信可能化を含みます。）、伝送、配布、出版、営業使用等をしてはならないものとします。
            </li>
          </ol>
        </div>
      </section>
      ...
      <section>
        ...
        <div className={styles['terms-wrapper']}>
          <ol className={styles['terms-list']}>
            ...
            <li>
              当サークルは、本サービスに起因してユーザーに生じたあらゆる損害について、一切の責任を負いません。ただし、本サービスに関する当サークルとユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合、この免責規定は適用されません。
            </li>
            <li>
      ...
      <section>
        ...
        <div className={styles['terms-wrapper']}>
          <ol className={styles['terms-list']}>
            ...
            <li>
              本サービスに関して紛争が生じた場合には、運営者住所を管轄する裁判所を専属的合意管轄とします。
            </li>
          </ol>
        </div>
      </section>
